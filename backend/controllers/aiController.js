...
export const askAI = async (req, res) => {
  try {
    ...
    try {
      await axios.post(
        'https://campus-learn-lms-3.onrender.com/ask',
        { question },
        { timeout: 2000 }
      )
    } catch {
      ...
      for (const note of notes) {
        ...
        await axios.post('https://campus-learn-lms-3.onrender.com/load', {
    ...
    const response = await axios.post('https://campus-learn-lms-3.onrender.com/ask', {
      question
    })
